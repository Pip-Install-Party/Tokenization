...
bool state3(std::ifstream& file, int& lineCount, int& commentLineCount, std::ostringstream& buffer) {
    char ch; 
    file.get(ch);  // Read the next character
...
bool state4(std::ifstream& file, int& lineCount, int& commentLineCount, std::ostringstream& buffer) {
    char ch; 
    file.get(ch);  // Read the next character
